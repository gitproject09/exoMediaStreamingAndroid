package com.sopan.azuresamples.exoplayer;
...
import com.sopan.azuresamples.R;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Azure media services url- After upload azure create three type of Manifest URL

        //Didn't works
       // manifestURL.setText("https://streamingendipointjasim-mediaserivcejasim-inct.streaming.media.azure.net/d72feea0-871d-4a54-a2ee-07734358eb8c/Video1.ism/manifest");

        //Works on HLS only
       // manifestURL.setText("https://streamingendipointjasim-mediaserivcejasim-inct.streaming.media.azure.net/d72feea0-871d-4a54-a2ee-07734358eb8c/Video1.ism/manifest(format=m3u8-cmaf)");

        //Works on HLS only
        //manifestURL.setText("https://streamingendipointjasim-mediaserivcejasim-inct.streaming.media.azure.net/d72feea0-871d-4a54-a2ee-07734358eb8c/Video1.ism/manifest(format=m3u8-aapl-v3)");

        //Works on DASH only
       // manifestURL.setText("https://streamingendipointjasim-mediaserivcejasim-inct.streaming.media.azure.net/d72feea0-871d-4a54-a2ee-07734358eb8c/Video1.ism/manifest(format=mpd-time-cmaf)");
        //Works on HLS only
        manifestURL.setText("https://streamingendipointjasim-mediaserivcejasim-inct.streaming.media.azure.net/83fb3973-4840-4016-b696-0cb457d7d6be/Video_Tutorial_2022-02-09-151204.ism/manifest(format=m3u8-cmaf)");
    ...
    private void startContent() throws Exception {
        ...
        Log.d("EXO-player", "player URL check: " + videoUrl.toString());
    ...
    private MediaSource buildMediaSource(Uri uri, String protocolType) throws Exception {
        ...
        /*MediaSource mediaSource = new HlsMediaSource(
                ...
                false,
                null, false, null);
        final LoopingMediaSource targetMediaSource = new LoopingMediaSource(mediaSource);*/
    ...
    private void updateDataBox() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            playerVersion.setText(version);
            contentFormat.setText(format);
            contentProtection.setText(protection);
            contentToken.setText(token);
        }
    }
